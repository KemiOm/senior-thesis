...
**Bouchet / YCRC details** (walltime vs `#SBATCH --time`, `HF_TOKEN`, `STAGGER_SEC`, `SPLIT_TASKS`, rsync): see header comments in **`scripts/submit_all_model_baselines.sh`** and **`scripts/run_prompt_baseline_all_tasks.slurm`**.
