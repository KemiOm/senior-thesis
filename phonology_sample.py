...
INPUT_DIR = SCRIPT_DIR / "output/poems_normalized"
OUTPUT_DIR = SCRIPT_DIR / "output/poems_annotated"
...
# Use project-local NLTK data (Prosodic needs punkt); avoids ~/nltk_data permission issues
_nltk_data = SCRIPT_DIR / "data" / "nltk_data"
